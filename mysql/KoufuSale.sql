...
/*Data for the table `create_orders` */
...
insert  into `custom_fields`(`id`,`fieldlabel`,`created_by`,`modified_by`,`created`,`modified`) values (2,'Size',2,2,'2015-03-17 02:30:49','2015-03-17 02:30:49');
insert  into `custom_fields`(`id`,`fieldlabel`,`created_by`,`modified_by`,`created`,`modified`) values (3,'Qty',2,2,'2015-03-17 02:33:29','2015-03-17 02:33:29');
insert  into `custom_fields`(`id`,`fieldlabel`,`created_by`,`modified_by`,`created`,`modified`) values (4,'Unit Price',2,2,'2015-03-17 02:33:45','2015-03-17 02:33:45');
insert  into `custom_fields`(`id`,`fieldlabel`,`created_by`,`modified_by`,`created`,`modified`) values (5,'Vat Price',2,2,'2015-03-17 02:36:46','2015-03-17 02:36:46');
insert  into `custom_fields`(`id`,`fieldlabel`,`created_by`,`modified_by`,`created`,`modified`) values (6,'Material',2,2,'2015-03-17 02:36:54','2015-03-17 02:36:54');
insert  into `custom_fields`(`id`,`fieldlabel`,`created_by`,`modified_by`,`created`,`modified`) values (7,'Color',2,2,'2015-03-17 02:37:03','2015-03-17 02:37:03');
insert  into `custom_fields`(`id`,`fieldlabel`,`created_by`,`modified_by`,`created`,`modified`) values (8,'Process',2,2,'2015-03-17 02:37:13','2015-03-17 02:37:13');
insert  into `custom_fields`(`id`,`fieldlabel`,`created_by`,`modified_by`,`created`,`modified`) values (9,'Packaging',2,2,'2015-03-17 02:37:23','2015-03-17 02:37:23');
insert  into `custom_fields`(`id`,`fieldlabel`,`created_by`,`modified_by`,`created`,`modified`) values (10,'OtherSpecs',2,2,'2015-03-17 02:37:41','2015-03-17 02:37:41');
insert  into `custom_fields`(`id`,`fieldlabel`,`created_by`,`modified_by`,`created`,`modified`) values (11,'Terms',2,2,'2015-03-17 02:37:51','2015-03-17 02:37:51');
insert  into `custom_fields`(`id`,`fieldlabel`,`created_by`,`modified_by`,`created`,`modified`) values (12,'Validity',2,2,'2015-03-17 02:38:02','2015-03-17 02:38:02');
insert  into `custom_fields`(`id`,`fieldlabel`,`created_by`,`modified_by`,`created`,`modified`) values (13,'Remarks',2,2,'2015-03-17 02:38:10','2015-03-17 02:38:10');
...
CREATE TABLE `processes` (
  ...
  `process_field_id` int(11) DEFAULT NULL,
  `created_by` int(11) DEFAULT NULL,
  `modified_by` int(11) DEFAULT NULL,
  `created` datetime DEFAULT NULL,
  `modified` datetime DEFAULT NULL,
...
/*Data for the table `quotation_options` */
