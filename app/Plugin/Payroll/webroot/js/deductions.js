...
function loadSummary(){
    ...
    $container.html('<img src="'+serverPath+'/img/loader.gif"/>');
      ...
      $.ajax({
            type: "POST",
            url: serverPath + "payroll/salaries/computeDeduction/",
...
function loadDeduction (element){
    ...
    $.ajax({
            type: "POST",
            url: serverPath + "payroll/deductions/index/",
...
$( ".datepick" ).datepicker({
 ...
 $('body').on('keyup','#DeductionAmount',function(e){
  ...
  $('body').on('click','.view_amortization',function(){
    ...
    $.ajax({
            type: "GET",
            url: serverPath + "payroll/deductions/view_amortization/"+$deductionId,
            dataType: "html",
            success: function(data) {
