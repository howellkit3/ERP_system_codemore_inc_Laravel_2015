                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-9">
                                                   <div class="form-group pull-left">
                                                    ...
                                                    <input type="radio" value="once" class="mode_type" id="optionsRadios1" name="data[Deduction][ mode]" <?php echo ($this->request->data['Deduction']['mode'] == 'once') ? 'checked' : ''; ?>>
                                                        <label for="optionsRadios1">
                                                            Once
                                                        </label>
                                                    </div>
                                                    <div class="radio inline-block">
                                                    <input type="radio" class="mode_type" value="installment" id="optionsRadios2" name="data[Deduction][mode]"  <?php echo ($this->request->data['Deduction']['mode'] == 'installment') ? 'checked' : ''; ?>>
