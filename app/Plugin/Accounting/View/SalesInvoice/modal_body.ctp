                    ...
                    <?php  } else if ($indicator == 'apc_dr') { ?>
                            ...
                            <?php  echo $this->Form->create('InvoiceForm',array(
                                    'url'=>(array('controller' => 'sales_invoice','action' => 'add_apc_pre_invoce', $deliveryUUID )),'class' => 'form-horizontal'));  ?>
                                ...
                                <div class="form-group delivery_number" >
                                    <label class="col-lg-3 control-label"><span style="color:red">*</span>APC DR no</label>
                                    <div class="col-lg-8">
                                        <?php 
