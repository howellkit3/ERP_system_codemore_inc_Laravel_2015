...
<?php $this->Html->addCrumb('Add', array('controller' => 'sections', 'action' => 'add')); ?>
                                    ...
                                    <div class="form-group">
                                		...
                                		<div class="form-group">
	                                        ...
	                                        <div class="col-lg-8">
	                                            ...
	                                            <?php echo $this->Form->input('Section.name',
                        ...
                        <div class="form-horizontal">
                            ...
                            <div class="multi-field clearfix">
                                ...
                                <div class="col-xs-2 col-md-2 2">
                                    <?php 
                                        echo $this->Form->submit('Submit Section Information', array('class' => 'btn btn-success pull-left',  'title' => 'Click here to add the section'));
                                    ?>
