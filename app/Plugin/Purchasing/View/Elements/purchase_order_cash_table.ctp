<?php  foreach ($purchaseOrderData as $purchaseOrderDataList ): ?>
        ...
        <tr class="">
            ...
            <td class="">
             ...
             <td class="">
                <?php echo ucfirst($userName[$purchaseOrderDataList['PurchaseOrder']['received_by']]) ?>
            </td>
            ...
            <td class="text-center">
                <?php 
                    ...
                    else if($purchaseOrderDataList['PurchaseOrder']['status'] == 12){ 
                        echo "<span class='label label-info'>Received by Cash</span>";
                    }
