...
<?php $this->Html->addCrumb('Edit', array('controller' => 'departments', 'action' => 'edit',$this->request->data['Department']['id'])); ?>
                        ...
                        <div class="form-horizontal">
                            ...
                            <div class="multi-field clearfix">
                                ...
                                <div class="col-xs-2 col-md-2 2">
                                    <?php 
                                        echo $this->Form->submit('Submit Department Information', array('class' => 'btn btn-success pull-left',  'title' => 'Click here to edit the department'));
                                    ?>
