...
<?php $this->Html->addCrumb('Process', array('controller' => 'settings', 'action' => 'processes')); 
							...
							<header class="main-box-header clearfix">
				                ...
				                <div class="filter-block pull-right">
				                    ...
				                    <?php
				                   		...
				                   		echo $this->Html->link('<i class="fa fa-pencil-square-o fa-lg"></i> Add Process', 
							                array(
							                		'controller' => 'process_departments', 
							                        'action' => 'add'
							                      ),
				                   ...
				                   // 		echo $this->Html->link('<i class="fa fa-pencil-square-o fa-lg"></i> Arrange Ordering', 
							                // array(
							                // 		'controller' => 'machines', 
							                //         'action' => 'add'
							                //       ),
				            ...
				            <div class="main-box-body clearfix">
				            	<div class="table-responsive">
									<table class="table table-striped table-hover">
										...
										<?php 
									        if(!empty($process)){
									            foreach ($process as $key => $processList): ?>
													<tbody aria-relevant="all" aria-live="polite" role="alert">
														<tr class="">
															<td class="">
									                           <?php //echo $processList['ProcessDepartment']['name']; ?>
									                        </td>
															<td class="">
									                           <?php echo $processList['ProcessDepartment']['name']; ?>
									                        </td>
									                        ...
									                        <td class="">
									                           <?php echo $processList['ProcessDepartment']['description']; ?>
									                        </td>

									                        <td class="">
									                           <?php echo $processList['ProcessDepartment']['remarks']; ?>
									                        </td>
									                       	...
									                       	<td>
									                      		<?php
																	echo $this->Html->link('<span class="fa-stack">
																		...
																		</span> ', array('controller' => 'process_departments', 'action' => 'edit',$processList['ProcessDepartment']['id']),array('class' =>' table-link','escape' => false,'title'=>'Edit Information'));
																		...
																		</span> ', array('controller' => 'process_departments', 'action' => 'delete',$processList['ProcessDepartment']['id']),array(
																			'class' =>' table-link',
																			'escape' => false,'title'=>'Edit Information',
																			'confirm' => 'Are you sure you want to delete '.$processList['ProcessDepartment']['name']. ' ?' 
																			));
