...
<?php $this->Html->addCrumb('Corrugated Lamination', array('controller' => 'jobs', 'action' => 'corrugated_lamination')); 
					...
					<div class="tab-content">
						<div class="tab-pane active" id="tab-calendar">
							<header class="main-box-header clearfix">
				                <h2 class="pull-left"><b>Corrugated Lamination</b> </h2>
				                <div class="filter-block pull-right">
				                 	<div class="form-group pull-left">
				                        <?php //echo $this->Form->create('Quotation',array('controller' => 'quotations','action' => 'search', 'type'=> 'get')); ?>
				                            <input placeholder="Search..." class="form-control searchCorrugatedLamination"  />
