				...
				<header class="main-box-header clearfix">
					...
					<div class="filter-block pull-right">
						<?php 
		                    ...
		                    echo $this->Html->link('<i class="fa fa-ticket fa-lg"></i> Create Job Ticket ', array('controller' => 'ticketing_system','action' => 'create_ticket',$this->request->data['Product']['uuid']),array('class' =>'btn btn-primary pull-right','escape' => false));
