...
<?php $this->Html->addCrumb('Add', array('controller' => 'quotation', 'action' => 'add')); ?>
									...
									<div class="table-responsive">
										<div class="col-lg-12">
											<div class="main-box">
												...
												<div class="main-box-body clearfix">
													<?php echo $this->Form->create('Quotation',array('url'=>(array('controller' => 'quotation','action' => 'add')),'class' => 'form-horizontal'));?>
														<?php 
														...
														<section class="cloneMe1 quotation_section">
															<div class="form-group">
																<div class="col-lg-3">
																	<?php 
						                                                echo $this->Form->input('Quotation.0.label', array(
						                                                    'options' => array('Item', 'Size', 'Qty','Price'),
						                                                    'alt' => 'type',
						                                                    'label' => false,
																...
																<div class="col-lg-8">
																	<?php 
						                                                echo $this->Form->input('Quotation.0.text', array('class' => 'form-control item_type',
						                                                    'alt' => 'address1',
						                                                    'label' => false));
						                                            ?>
																</div>
