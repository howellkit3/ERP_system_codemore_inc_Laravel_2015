                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="main-box">
                        	...
                        	<?php foreach ($this->request->data['ContactPerson'] as $key => $value) { 
	                            ...
	                            <section class="cloneMe1 contactPerson_section"> 
	                                 	...
	                                 	<?php foreach ($this->request->data['ContactPersonData'] as $key => $value) {
		                                    ...
		                                    <section class="cloneMe1 contactPersonNumber_section">   
		                                        <div class="form-group">
		                                            ...
		                                            <div class="col-lg-6">
		                                                <?php 
		                                                    echo $this->Form->input('ContactPersonData.0.Contact.0.number', array('class' => 'form-control','label' => false,'value' => !empty($value['number']) ? $value['number'] : '' ));
		                                                ?>
		                                            </div>
		                                            <div class="col-lg-2">
			                           		...
			                           		echo $this->Form->input('ContactPersonData.0.Email.0.id', array('class' => 'form-control item_type',
			                                    ...
			                                    <section class="cloneMe1 contactPersonEmail_section">
			                                        <div class="form-group">
			                                            ...
			                                            <div class="col-lg-6">
			                                                <?php 
			                                                    echo $this->Form->input('ContactPersonData.0.Email.0.email', array('class' => 'form-control','label' => false,'value' => !empty($value['email']) ? $value['email'] : '' ));
			                                                ?>
			                                            </div>
			                                            <div class="col-lg-2">
	                                ...
	                                <div class="main-box-body clearfix">
		                                ...
		                                <?php foreach ($this->request->datas['ContactPersonData'] as $key => $value) { 
