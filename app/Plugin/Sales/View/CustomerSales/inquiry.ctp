    ...
    <div class="col-lg-12">
        <div class="main-box clearfix body-pad">
            <header class="main-box-header clearfix">
                <h2 class="pull-left"><b>Inquiry List</b></h2>
                
                <div class="filter-block pull-right">
                    
                    <?php

                        echo $this->Html->link('<i class="fa fa-plus-circle fa-lg"></i> Add Inquiry ', array('controller' => 'customer_sales', 'action' => 'inquiry_form'),array('class' =>'btn btn-primary pull-right','escape' => false));
