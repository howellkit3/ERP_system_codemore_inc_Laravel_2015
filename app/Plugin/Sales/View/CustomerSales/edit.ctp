...
<div class="row">
    <div class="col-lg-12">
        ...
        <?php echo $this->Form->input('Company.id', array('class' => 'form-control item_type',
            ...
            if (count($this->request->data['Address']) > 0 ) :
             foreach ($this->request->data['Address'] as $key => $value) { 
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="main-box">
                         ...
                         <section class="cloneMe1 contactPerson_section">
                            <div class="main-box-body clearfix">
                                <div class="main-box-body clearfix">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-9">
                                                <?php 
                                                    ...
                                                    echo $this->Form->input('ContactPersonData.'.$key.'.ContactPerson.'.$key.'.id', array('class' => 'form-control','label' => false,'value' => !empty($value['ContactPerson']['id']) ? $value['ContactPerson']['id'] : ''));
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-9">
                                                <?php
                                                    ...
                                                    echo $this->Form->input('ContactPersonData.'.$key.'.ContactPerson.'.$key.'.middlename', array('class' => 'form-control','label' => false,'value' => !empty($value['ContactPerson']['middlename']) ? $value['ContactPerson']['middlename'] : ''));
                                                ?>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-9">
                                                <?php
                                                    ...
                                                    echo $this->Form->input('ContactPersonData.'.$key.'.ContactPerson.'.$key.'.lastname', array('class' => 'form-control','label' => false,'value' => !empty($value['ContactPerson']['lastname']) ? $value['ContactPerson']['lastname'] : ''));
                                                ?>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-9">
                                                <?php
                                                    ...
                                                    echo $this->Form->input('ContactPersonData.'.$key.'.ContactPerson.'.$key.'.position', array('class' => 'form-control','label' => false,'value' => !empty($value['ContactPerson']['position']) ? $value['ContactPerson']['position'] : ''));
                                                ?>
                                            </div>
                                        </div>
                                   ...
                                   <?php foreach ($value['Email'] as $indexkey => $indexvalue) {
                         ...
                         <?php foreach ($value['Contact'] as $indexkey => $indexvalue) {
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-2">
                                                    <?php 
                                                        ...
                                                        echo $this->Form->input('ContactPersonData.'.$key.'.Contact.'.$indexkey.'.id');
