...
<div class="form-group">
  ...
  <div class="col-lg-8">
      	<!-- <div class="input-group"> -->
			...
			<input name="data[ProductSpecificationComponent][<?php echo $counter ;?>][name]" value="<?php echo $formatDataSpecs['ProductSpecificationComponent']['name'] ?>" class="required form-control label<?php echo $plusCounter ;?> editMe" type="text" disabled />
