<?php foreach ($productData as $ProductDataList ):?>
    ...
    <tbody aria-relevant="all" aria-live="polite" role="alert">
        ...
        <tr class="">
            ...
            <td>
                <?php  echo ucfirst($itemCategoryData[$ProductDataList['Product']['item_category_holder_id']]) ?>
            </td>

            <td>
                <?php  echo ucfirst($itemTypeData[$ProductDataList['Product']['item_type_holder_id']]) ?>
            </td>
            ...
            <td>
                <?php 
                    ...
                    </span> ', array('controller' =>'products', 'action' => 'edit',$ProductDataList['Product']['id']),array('class' =>' table-link','escape' => false,'title'=>'Edit Information')); 
                ?>
                <?php
                    echo $this->Html->link('<span class="fa-stack">
                    <i class="fa fa-square fa-stack-2x"></i>
