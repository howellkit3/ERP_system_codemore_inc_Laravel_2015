                        ...
                        <div class="main-box">
                                ...
                                <br/>            
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-9">
                                                    <?php 
                                                        echo $this->Form->input('0.name', array('class' => 'form-control item_type','label' => false));
                                                    ?>
                                                </div>
                                            </div>
                                             ...
                                             <div class="form-group">
                                                ...
                                                <div class="col-lg-9">
                                                    <?php 
                                                        echo $this->Form->input('0.unit', array('class' => 'form-control required','label' => false));
                                                    ?>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-9">
                                                   <?php 
                                                        echo $this->Form->input('0.unit_cost', array('class' => 'form-control required number','label' => false,'type' => 'text'));
                                                    ?>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-9">
                                                    <?php 
                                                        echo $this->Form->input('0.qty', array('class' => 'form-control required number','label' => false,'type' => 'text'));
                                                    ?>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-9">
                                                     <?php 
                                                        echo $this->Form->textarea('0.description', array('class' => 'form-control required','label' => false));
                                                    ?>
                                                </div>
                                            </div>
