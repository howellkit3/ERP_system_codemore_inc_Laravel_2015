				...
				<div class="col-lg-12">
					<div class="main-box">
						<header class="main-box-header clearfix">
							<h2 class="pull-left">Tranmittal Record Details</h2>

							<?php 
	                        echo $this->Html->link('<i class="fa fa-arrow-circle-left fa-lg"></i> Go Back ', array('controller' => 'deliveries','action' => 'delivery_transmittal_record'),array('class' =>'btn btn-primary pull-right','escape' => false));
                   			 ?>
										...
										<div class="col-lg-8">
											<?php 
	                                            echo $this->Form->input('Transmittal.dr_uuid', array(
							                                                    ...
							                                                    'label' => false,       
							                                                    'placeholder' => 'Delivery Receipt Number',
							                                                    'value' => $transmittalDataList['Transmittal']['dr_uuid'],
							                                                    'fields' =>array('name')));
                                            ?>
										</div>
									</div>
