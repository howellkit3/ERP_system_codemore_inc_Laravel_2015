		...
		<div class="row">
			<div class="col-lg-12">
				...
				<?php //foreach ($deliveryEdit as $deliveryDataList): ?>	
					...
					<?php // pr($clientsOrder); 
                        echo $this->Html->link('<i class="fa fa-arrow-circle-left fa-lg"></i> Go Back ', array('controller' => 'deliveries', 'action' => 'view', $clientsOrder['ClientOrderDeliverySchedule']['id'],$clientsOrder['QuotationDetail']['quotation_id'],$clientsOrder['ClientOrderDeliverySchedule']['uuid'],$deliveryEdit['Delivery']['clients_order_id'],
                        	'delivery_id' => $deliveryEdit['Delivery']['id'] 
