...
<?php $this->Html->addCrumb('Edit', array('controller' => 'tools', 'action' => 'edit',$this->request->data['Tool']['id'])); ?>
...
<?php echo $this->Form->create('Tool',array('url'=>(array('controller' => 'tools','action' => 'edit')),
                                    ...
                                    <div class="form-group">
                                        <div class="col-lg-12">
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-4">
                                                    <?php 
                                                        echo $this->Form->submit('Submit Status Information', array('class' => 'btn btn-success pull-left',  'title' => 'Click here to add the Tool'));
                                                        echo "&nbsp;";
