...
<?php $this->Html->addCrumb('Add', array('controller' => 'settings', 'action' => 'department')); ?>
...
<?php echo $this->Form->create('Department',array('url'=>(array('controller' => 'settings','action' => 'department')),
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-4">
                                                    <?php 
                                                        ...
                                                        echo "&nbsp;";
                                                        echo $this->Html->link('Cancel ', array('controller' => 'settings', 'action' => 'index','plugin' => 'human_resource'),array('class' =>'btn btn-default ','escape' => false));
...
<script>
   jQuery(document).ready(function($){
        $("#DepartmentDepartmentForm").validate();
