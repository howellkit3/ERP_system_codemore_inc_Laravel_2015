...
<?php $this->Html->addCrumb('Edit', array('controller' => 'settings', 'action' => 'edit_position')); ?>
...
<?php echo $this->Form->create('Position',array('url'=>(array('controller' => 'settings','action' => 'edit_position')),
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-4">
                                                    <?php 
                                                        ...
                                                        echo "&nbsp;";
                                                        echo $this->Html->link('Cancel ', array('controller' => 'settings', 'action' => 'index','tab'=>'position','plugin' => 'human_resource'),array('class' =>'btn btn-default ','escape' => false));
...
<script>
   jQuery(document).ready(function($){
        $("#PositionEditPositionForm").validate();
