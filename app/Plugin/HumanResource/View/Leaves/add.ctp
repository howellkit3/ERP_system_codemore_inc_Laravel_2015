...
<?php $this->Html->addCrumb('Request', array('controller' => 'leaves', 'action' => 'add')); ?>
...
<?php echo $this->Form->create('Leave',array('url'=>(array('controller' => 'leaves','action' => 'add')),
                                    ...
                                    <div class="form-group">
                                        <div class="col-lg-12">
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-4">
                                                    <?php 
                                                        echo $this->Form->submit('Submit Status Information', array('class' => 'btn btn-success pull-left',  'title' => 'Click here to add employee leave'));
                                                        echo "&nbsp;";
