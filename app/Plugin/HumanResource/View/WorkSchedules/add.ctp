                            ...
                            <div class="main-box-body clearfix">
                                ...
                                <div class="col-lg-6">    
                                    ...
                                    <div class="form-group">
                                       <div class="col-lg-12">
                                            <div class="form-group">
                                                <label for="inputEmail1" class="col-lg-3 control-label"><span style="color:red">*</span>Search Name</label>
                                                <div class="col-lg-9">
                                                  
                                                    <?php
                                                        echo $this->Form->input('WorkSchedule.employee_id',
                                                            array(
                                                                'id' => 'SearchEmployee',
                                        ...
                                        <div class="col-lg-12">
                                            ...
                                            <div class="col-lg-9">
                                                ...
                                                <?php
                                                    ...
                                                    echo $this->Form->input('WorkSchedule.shift_id', array(
                                                        'type' => 'select',
                                                        'empty' => '--- Select shift ---',
                                                        'class' => 'form-control col-lg-6 autocomplete',
                                                        'options' => $workshifts,
                                                        'label' => false));
                                                ?>
