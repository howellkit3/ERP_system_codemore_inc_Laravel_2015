...
<?php $this->Html->addCrumb('Edit', array('controller' => 'agencies', 'action' => 'edit',$this->request->data['Agency']['id'])); ?>
...
<?php echo $this->Form->create('Agency',array('url'=>(array('controller' => 'agencies','action' => 'edit')),
