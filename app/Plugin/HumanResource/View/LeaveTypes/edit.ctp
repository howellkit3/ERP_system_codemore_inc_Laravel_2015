...
<?php $this->Html->addCrumb('Edit', array('controller' => 'leave_types', 'action' => 'edit',$this->request->data['LeaveType']['id'])); ?>
                                    ...
                                    <div class="form-group">
                                        <div class="col-lg-12">
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-4">
                                                    <?php 
                                                        echo $this->Form->submit('Submit Status Information', array('class' => 'btn btn-success pull-left',  'title' => 'Click here to edit leave type'));
                                                        echo "&nbsp;";
