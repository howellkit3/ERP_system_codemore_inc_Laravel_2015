...
<?php echo $this->Form->create('Breaktime',array('url'=>(array('controller' => 'breaktimes','action' => 'edit')),
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-9">
                                                    ...
                                                    <?php
                                                        ...
                                                        echo $this->Form->input('Breaktime.id');
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-9">
                                                     ...
                                                     <div class="col-lg-5 input-append bootstrap-timepicker">
                                                        <?php
                                                                echo $this->Form->input('Breaktime.from', array('type' => 'text','class' => 'form-control col-lg-6 required timepicker','label' => false));
                                                         ?>
