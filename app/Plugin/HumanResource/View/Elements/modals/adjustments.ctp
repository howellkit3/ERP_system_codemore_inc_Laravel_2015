<!-- Standard Bootstrap Modal -->
    <div class="modal fade" id="addAjustments" role="dialog" data-id="" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                    <h4 class="modal-title"> Add Ajustments </h4>
                </div>
                 <?php echo $this->Form->create('Adjustment',array('url' => array('controller' => 'salaries','action' => 'adjustments_edit'))); ?>
    ...
    <!-- Standard Bootstrap Modal -->
    <div class="modal fade" id="adjustmentModal" role="dialog" data-id="" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
     ...
     <div class="modal fade" id="addAjustmentImport" role="dialog" data-id="" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
