        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                 <?php echo $this->Form->create('Attendance',array('url'=>(array('controller' => 'attendances','action' => 'add')),'class' => 'form-horizontal'));?>
                        <div class="form-group">
                            ...
                            <div class="col-lg-9">
                                <?php echo $this->Form->input('Attendance.employee_id',
                                         array('class' => 'item_type autocomplete required',
                                        'options' => $employees,
                                        'alt' => 'Employee name',
