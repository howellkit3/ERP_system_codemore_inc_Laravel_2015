		...
		<div class="row">
			<div class="col-lg-12">
				<header class="main-box-header clearfix">
					...
					<?php 
                        echo $this->Html->link('<i class="fa fa-arrow-circle-left fa-lg"></i> Go Back ', array('controller' => 'payroll_settings', 'action' => 'index'),array('class' =>'btn btn-primary pull-right','escape' => false));
                    ?>
				</header>
							...
							<div class="table-responsive">
								...
								<?php foreach ($ranges as $key => $range) { ?>
									...
									<tr>
										...
										</span> ', array('controller' => 'payroll_settings', 'action' => 'philhealth_ranges_add',$range['PhilHealthRange']['id']),array('class' =>' table-link small-link-icon','escape' => false,'title'=>'Edit Information'));
										
										echo $this->Html->link('<span class="fa-stack">
										<i class="fa fa-square fa-stack-2x"></i>
										<i class="fa fa-trash-o fa-stack-1x fa-inverse"></i>&nbsp;&nbsp;&nbsp;<span class ="post"><font size = "1px"> Delete </font></span>
										</span>', array('controller' => 'payroll_settings', 'action' => 'philhealth_ranges_delete',$range['PhilHealthRange']['id']),array('class' =>' table-link small-link-icon','escape' => false,'title'=>'Delete Information','confirm' => 'Do you want to delete this Process ?'));
										?>
										</td>
								</tr>
								<?php } ?>
