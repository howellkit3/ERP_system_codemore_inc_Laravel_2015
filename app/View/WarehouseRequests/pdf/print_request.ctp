	...
	<div class="col-lg-12">
		<div class="main-box main-pdf"  >
				...
				<table>
					...
					<td>
						<center>
							<h4 style = "margin-bottom:0px; margin-top:0px; padding-top:0px;"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;WAREHOUSE REQUISITION</h4>
						</center>
					</td>
					</tr>
				...
				<table style=" border:1px solid black;border-collapse:collapse; margin-bottom:0px;  ">
					...
					<tr>
						...
						<td align = "center" style="border:1px solid black; font-size:80% "><?php echo empty($outRecordData['ItemRecord'][$key]['stock_quantity']) ? (!empty($value['stock_quantity'])? $value['stock_quantity']: 0) : $outRecordData['ItemRecord'][$key]['stock_quantity'];  ?></td>
