    ...
    <?php $daily = !empty($taxes['monthly']) ? $taxes['daily'] : ''; ?>
       <table class="table table-bordered">
                ...
                <tr>
                 <td>
                  <?php echo $this->Form->input('TaxDeduction.id',array(
                    ...
                    'value' => !empty($taxes['monthly']['TaxDeduction']['id']) ? $taxes['monthly']['TaxDeduction']['id'] : ''
                  )); ?>
                  ...
                  <?php echo $this->Form->input(
                    ...
                    'value' => !empty($taxes['monthly']['TaxDeduction']['tax_1']) ? $taxes['monthly']['TaxDeduction']['tax_1'] : '0.00',
                    'label' => false, 
                    'class' => 'form-control cols-lg-2 number'
                  )); ?> + 
                  <?php echo $this->Form->input(
                    'TaxDeduction.tax_1_percent',array(
                    'value' => !empty($taxes['monthly']['TaxDeduction']['tax_1_percent']) ? $taxes['monthly']['TaxDeduction']['tax_1_percent'] : '0',
                    'label' => false,
                    'class' => 'form-control cols-lg-2 number'
                  )); ?>% Over 
                 </td>
                 ...
                 'value' => !empty($taxes['monthly']['TaxDeduction']['tax_2']) ? $taxes['monthly']['TaxDeduction']['tax_2'] : '0.00',
                 'label' => false,
                 'class' => 'form-control cols-lg-2 number',
                 )); ?> + 
                  <?php echo $this->Form->input('TaxDeduction.tax_2_percent',array(
                  'value' => !empty($taxes['monthly']['TaxDeduction']['tax_2_percent']) ? $taxes['monthly']['TaxDeduction']['tax_2_percent'] : '0',
                  'label' => false,
                 ...
                 array(
                 'value' => !empty($taxes['monthly']['TaxDeduction']['tax_3']) ? $taxes['monthly']['TaxDeduction']['tax_3'] : '0.00',
                 'label' => false,
                 'class' => 'form-control cols-lg-2 number'
                 )); ?> + 
                  <?php echo $this->Form->input('TaxDeduction.tax_3_percent',
                    array(
                    'value' => !empty($taxes['monthly']['TaxDeduction']['tax_3_percent']) ? $taxes['monthly']['TaxDeduction']['tax_3_percent'] : '0',
                    'label' => false,
                    'class' => 'form-control cols-lg-2 number'
                    )); ?>% Over 
                </td>
                 <td>
                  ...
                  'value' => !empty($taxes['monthly']['TaxDeduction']['tax_4']) ? $taxes['monthly']['TaxDeduction']['tax_4'] : '0.00',
                  'label' => false,
                  'class' => 'form-control cols-lg-2 number'
                  )); ?> + 
                  <?php echo $this->Form->input('TaxDeduction.tax_4_percent',array(
                  'value' => !empty($taxes['monthly']['TaxDeduction']['tax_4_percent']) ? $taxes['monthly']['TaxDeduction']['tax_4_percent'] : '0'
                  ,'label' => false,
                  'class' => 'form-control cols-lg-2 number'
                  )); ?>% Over 
                </td>
                 ...
                 'value' => !empty($taxes['monthly']['TaxDeduction']['tax_5']) ? $taxes['monthly']['TaxDeduction']['tax_5'] : '0.00',
                 'label' => false,
                 'class' => 'form-control cols-lg-2 number'
                 )); ?> + 
                <?php echo $this->Form->input('TaxDeduction.tax_5_percent',
                  array(
                  'value' => !empty($taxes['monthly']['TaxDeduction']['tax_5_percent']) ? $taxes['monthly']['TaxDeduction']['tax_5_percent'] : '0',
                  'label' => false,
                  'class' => 'form-control cols-lg-2 number'
                  )); ?>% Over 
                </td>
                 ...
                 array(
                 'value' => !empty($taxes['monthly']['TaxDeduction']['tax_6']) ? $taxes['monthly']['TaxDeduction']['tax_6'] : '0.00',
                 'label' => false,
                 'class' => 'form-control cols-lg-2 number'
                 )); ?> + 
                  <?php 
                  ...
                  array(
                  'value' => !empty($taxes['monthly']['TaxDeduction']['tax_6_percent']) ? $taxes['monthly']['TaxDeduction']['tax_6_percent'] : '0',
                  'label' => false, 'class' => 'form-control cols-lg-2 number'
                  )); ?>% Over 
                </td>
                 <td> 
                 <?php echo $this->Form->input('TaxDeduction.tax_7',array(
                 'value' => !empty($taxes['monthly']['TaxDeduction']['tax_7']) ? $taxes['monthly']['TaxDeduction']['tax_7'] : '0.00',
                 'label' => false, 
                 'class' => 'form-control cols-lg-2 number'
                 )); ?> + 
                <?php echo $this->Form->input('TaxDeduction.tax_7_percent',array(
                'value' => !empty($taxes['monthly']['TaxDeduction']['tax_7_percent']) ? $taxes['monthly']['TaxDeduction']['tax_7_percent'] : '0',
                'label' => false, 
                'class' => 'form-control cols-lg-2 number'
                )); ?>% Over 
                  </td>
                 ...
                 'value' => !empty($taxes['monthly']['TaxDeduction']['tax_8']) ? $taxes['monthly']['TaxDeduction']['tax_8'] : '0.00' ,
                 'label' => false, 
                 'class' => 'form-control cols-lg-2 number'
                 )); ?> + 
                  <?php echo $this->Form->input('TaxDeduction.tax_8_percent',array(
                  'value' => !empty($taxes['monthly']['TaxDeduction']['tax_8_percent']) ? $taxes['monthly']['TaxDeduction']['tax_8_percent'] : '0' ,
                  'label' => false,
                  'class' => 'form-control cols-lg-2 number'
                  )); ?>% Over 
                  </td>
        ...
        <table class="table table-bordered">
                ...
                $monthly_taxes = !empty($taxes['monthly']['Tax']) ? $taxes['monthly']['Tax'] : ''; 

                 $status = array('Z' => 'Z', 'S_ME' => 'S / ME', 'S1_ME1' => 'ME1 / S1','S2_ME2' => 'ME2 / S2','S3_ME3' => 'ME3 / S3', 'S4_ME4' => 'ME4 / S4'); ?>

                  <tbody>
                       <?php if (!empty($monthly_taxes)) : ?>

                          <?php $key = 0; foreach ($monthly_taxes as $stats_key => $stats) : ?>
                              <tr>
                       ...
                       <?php else : ?>
                            ...
                            <?php $key = 0; foreach ($status as $stats_key => $stats) : ?>
                              <tr>
                                ...
                                <td class="text-center">
                                <?php 
                                  echo $this->Form->input($key.'.type',array('value' => 'monthly','type' => 'hidden','label' => false, 'class' => 'form-control cols-lg-2')); 
