 <?php echo $this->Form->create('Tax',array('url'=>(array('controller' => 'payroll_settings','action' => 'tax_settings','daily')))); ?>
    ...
    <?php $daily = !empty($taxes['daily']) ? $taxes['daily'] : ''; ?>
                ...
                <tr>
                 <td>
                  <?php echo $this->Form->input('TaxDeduction.id',array(
                    ...
                    'value' => !empty($taxes['daily']['TaxDeduction']['id']) ? $taxes['daily']['TaxDeduction']['id'] : ''
                  )); ?>
                  ...
                  <?php echo $this->Form->input(
                    ...
                    'value' => !empty($taxes['daily']['TaxDeduction']['tax_1']) ? $taxes['daily']['TaxDeduction']['tax_1'] : '0.00',
                    'label' => false, 
                    'class' => 'form-control cols-lg-2 number'
                  )); ?> + 
                  <?php echo $this->Form->input(
                    'TaxDeduction.tax_1_percent',array(
                    'value' => !empty($taxes['daily']['TaxDeduction']['tax_1_percent']) ? $taxes['daily']['TaxDeduction']['tax_1_percent'] : '0',
                    'label' => false,
                    'class' => 'form-control cols-lg-2 number'
                  )); ?>% Over 
                 </td>
                 ...
                 'value' => !empty($taxes['daily']['TaxDeduction']['tax_2']) ? $taxes['daily']['TaxDeduction']['tax_2'] : '0.00',
                 'label' => false,
                 'class' => 'form-control cols-lg-2 number',
                 )); ?> + 
                  <?php echo $this->Form->input('TaxDeduction.tax_2_percent',array(
                  'value' => !empty($taxes['daily']['TaxDeduction']['tax_2_percent']) ? $taxes['daily']['TaxDeduction']['tax_2_percent'] : '0',
                  'label' => false,
                 ...
                 array(
                 'value' => !empty($taxes['daily']['TaxDeduction']['tax_3']) ? $taxes['daily']['TaxDeduction']['tax_3'] : '0.00',
                 'label' => false,
                 'class' => 'form-control cols-lg-2 number'
                 )); ?> + 
                  <?php echo $this->Form->input('TaxDeduction.tax_3_percent',
                    array(
                    'value' => !empty($taxes['daily']['TaxDeduction']['tax_3_percent']) ? $taxes['daily']['TaxDeduction']['tax_3_percent'] : '0',
                    'label' => false,
                    'class' => 'form-control cols-lg-2 number'
                    )); ?>% Over 
                </td>
                 <td>
                  ...
                  'value' => !empty($taxes['daily']['TaxDeduction']['tax_4']) ? $taxes['daily']['TaxDeduction']['tax_4'] : '0.00',
                  'label' => false,
                  'class' => 'form-control cols-lg-2 number'
                  )); ?> + 
                  <?php echo $this->Form->input('TaxDeduction.tax_4_percent',array(
                  'value' => !empty($taxes['daily']['TaxDeduction']['tax_4_percent']) ? $taxes['daily']['TaxDeduction']['tax_4_percent'] : '0'
                  ,'label' => false,
                  'class' => 'form-control cols-lg-2 number'
                  )); ?>% Over 
                </td>
                 ...
                 'value' => !empty($taxes['daily']['TaxDeduction']['tax_5']) ? $taxes['daily']['TaxDeduction']['tax_5'] : '0.00',
                 'label' => false,
                 'class' => 'form-control cols-lg-2 number'
                 )); ?> + 
                <?php echo $this->Form->input('TaxDeduction.tax_5_percent',
                  array(
                  'value' => !empty($taxes['daily']['TaxDeduction']['tax_5_percent']) ? $taxes['daily']['TaxDeduction']['tax_5_percent'] : '0',
                  'label' => false,
                  'class' => 'form-control cols-lg-2 number'
                  )); ?>% Over 
                </td>
                 ...
                 array(
                 'value' => !empty($taxes['daily']['TaxDeduction']['tax_6']) ? $taxes['daily']['TaxDeduction']['tax_6'] : '0.00',
                 'label' => false,
                 'class' => 'form-control cols-lg-2 number'
                 )); ?> + 
                  <?php 
                  ...
                  array(
                  'value' => !empty($taxes['daily']['TaxDeduction']['tax_6_percent']) ? $taxes['daily']['TaxDeduction']['tax_6_percent'] : '0',
                  'label' => false, 'class' => 'form-control cols-lg-2 number'
                  )); ?>% Over 
                </td>
                 <td> 
                 <?php echo $this->Form->input('TaxDeduction.tax_7',array(
                 'value' => !empty($taxes['daily']['TaxDeduction']['tax_7']) ? $taxes['daily']['TaxDeduction']['tax_7'] : '0.00',
                 'label' => false, 
                 'class' => 'form-control cols-lg-2 number'
                 )); ?> + 
                <?php echo $this->Form->input('TaxDeduction.tax_7_percent',array(
                'value' => !empty($taxes['daily']['TaxDeduction']['tax_7_percent']) ? $taxes['daily']['TaxDeduction']['tax_7_percent'] : '0',
                'label' => false, 
                'class' => 'form-control cols-lg-2 number'
                )); ?>% Over 
                  </td>
                 ...
                 'value' => !empty($taxes['daily']['TaxDeduction']['tax_8']) ? $taxes['daily']['TaxDeduction']['tax_8'] : '0.00' ,
                 'label' => false, 
                 'class' => 'form-control cols-lg-2 number'
                 )); ?> + 
                  <?php echo $this->Form->input('TaxDeduction.tax_8_percent',array(
                  'value' => !empty($taxes['daily']['TaxDeduction']['tax_8_percent']) ? $taxes['daily']['TaxDeduction']['tax_8_percent'] : '0' ,
                  'label' => false,
                  'class' => 'form-control cols-lg-2 number'
                  )); ?>% Over 
                  </td>
 ...
 <table class="table table-bordered">
                ...
                $daily_taxes = !empty($taxes['daily']['Tax']) ? $taxes['daily']['Tax'] : ''; 

                 $status = array('Z' => 'Z', 'S_ME' => 'S / ME', 'S1_ME1' => 'ME1 / S1','S2_ME2' => 'ME2 / S2','S3_ME3' => 'ME3 / S3', 'S4_ME4' => 'ME4 / S4'); ?>

                  <tbody>
                       <?php if (!empty($daily_taxes)) : ?>

                          <?php $key = 0; foreach ($daily_taxes as $stats_key => $stats) : ?>
                              <tr>
