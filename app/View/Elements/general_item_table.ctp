        ...
        <tr class="">
            ...
            <td>
                <?php
                    echo $this->Html->link('<span class="fa-stack">
                        ...
                        <i class="fa fa-search-plus fa-stack-1x fa-inverse"></i>&nbsp;<span class ="post"><font size = "1px"> View </font></span>
                                        ...
                                        $generalItemDataList['GeneralItem']['id']), array(
                ...
                <?php
                    ...
                    </span> ', array('controller' => 'settings', 'action' => 'general_item_edit',$generalItemDataList['GeneralItem']['id']),array('class' =>' table-link small-link-icon','escape' => false,'title'=>'Edit Information'));
                ?>
                 ...
                 <?php
                    ...
                    </span>', array('controller' => 'settings', 'action' => 'deleteGeneralItem',$generalItemDataList['GeneralItem']['id']),array('class' =>' table-link small-link-icon','escape' => false,'title'=>'Delete Information','confirm' => 'Do you want to delete this General Item?'));
                ?>
