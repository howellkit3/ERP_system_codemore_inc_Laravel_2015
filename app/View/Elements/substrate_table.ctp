        ...
        <tr class="">
            ...
            <td>
                ...
                <?php
                    ...
                    </span> ', array('controller' => 'settings', 'action' => 'substrate_edit',$substrateDataList['Substrate']['id']),array('class' =>' table-link','escape' => false,'title'=>'Edit Information'));
                ?>
                 ...
                 <?php
                    ...
                    </span>', array('controller' => 'settings', 'action' => 'deleteSubstrate',$substrateDataList['Substrate']['id']),array('class' =>' table-link','escape' => false,'title'=>'Delete Information','confirm' => 'Do you want to delete this General Item?'));
                ?>
