        ...
        <tr class="">
            ...
            <td>
                ...
                <?php
                    ...
                    </span> ', array('controller' => 'settings', 'action' => 'substrate_edit',$substrateDataList['Substrate']['id'],$indicator),array('class' =>' table-link small-link-icon','escape' => false,'title'=>'Edit Information'));
                ?>
