<?php foreach ($corrugatedPaperData as $corrugatedPaperDataList ):?>
        ...
        <tr class="">
            ...
            <td class="text-center">
                <?php echo ucfirst($categoryData[$corrugatedPaperDataList['CorrugatedPaper']['category_id']]) ?>
            </td>

            <td class="text-center">
                <?php echo ucfirst($typeData[$corrugatedPaperDataList['CorrugatedPaper']['type_id']]) ?>
            </td>

            <td class="text-center">
                <?php echo ucfirst(!empty($supplierData[$corrugatedPaperDataList['CorrugatedPaper']['manufacturer_id']]) ? $supplierData[$corrugatedPaperDataList['CorrugatedPaper']['manufacturer_id']] : " ") ?>
            </td>
