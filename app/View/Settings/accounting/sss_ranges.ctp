...
<div class="row">
	<div class="col-lg-12">
		...
		<?php echo $this->Form->create('SssRange',array('url'=>(array('controller' => 'settings','action' => 'sss_ranges_add'))));?>
							...
							<div class="table-responsive">
								...
								<?php foreach ($ranges as $key => $range) { ?>
									...
									<tr>
										...
										</span> ', array('controller' => 'settings', 'action' => 'sss_ranges_add',$range['SssRange']['id']),array('class' =>' table-link small-link-icon','escape' => false,'title'=>'Edit Information'));
										?>
