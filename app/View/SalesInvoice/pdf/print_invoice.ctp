  ...
  height: 100%;background-repeat:no-repeat;">
	<div class="col-lg-12">
		<div class="main-box main-pdf" >
			...
			<table class="layout" style="line-height:11px;padding-top:18px; font-family: Verdana , Geneva, sans-serif;">
				<thead>
					<tr>	
				...
				<thead>
					<tr>	
						<td style="width:250px;">
							<center><?php echo strtoupper($approved['User']['first_name'])?> <?php echo strtoupper($approved['User']['last_name'])?></center>
						</td>
						<td style="width:240px;">
							<center>EMMA L. GOLFO</center>
						</td>
					</tr>
