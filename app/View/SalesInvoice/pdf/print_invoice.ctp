  ...
  height: 100%;background-repeat:no-repeat;">
	<div class="col-lg-12">
		<div class="main-box main-pdf" >
			<br><br><br><br><br>
			<table class="layout" style="line-height:14px;padding-top:12px; font-family: Verdana , Geneva, sans-serif;">
				<thead >
					<tr>	
					...
					<tr>
						...
						<td style="width:100px;text-align:right; font-family: Verdana , Geneva, sans-serif; "><?php echo (new \DateTime())->format('m/d/Y'); ?></td>
					</tr>
					<tr>
						<td style="width:100px;"> </td>
					...
					<tr>
						<td style="width:100px;"> </td>
						<td style="width:470px; font-family: Verdana , Geneva, sans-serif; "><?php echo ucfirst($companyData['Address'][0]['address1'])?></td>
			...
			<table class="table table-bordered" style="line-height:20px; font-family: Verdana , Geneva, sans-serif;">
				<thead>
					<tr style = "font-family: Verdana , Geneva, sans-serif;">
						...
						<td class="td-heigth" style="width:125px;border:1px solid #FFFFFF;text-align:right;font-family: Verdana , Geneva, sans-serif; ">
			...
			<table class="layout" style="line-height:11px;padding-top:18px; width:660px;text-align:right;font-family: Verdana , Geneva, sans-serif;">
			...
			<br><br><br>
			<table class="layout" style="line-height:12px;padding-top:8px; font-family: Verdana , Geneva, sans-serif;">
				<thead >
					<tr >	
