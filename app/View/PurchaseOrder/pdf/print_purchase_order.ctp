...
<?php include('word.css'); ?>
		...
		<table class="layout" style =" margin:0px; padding:0px; width:753px;">
			...
			<tr>
				...
				<img src="<?php echo Router::url('/', true) ?>img/koufu_logo.png" alt="logo" style="width:165px;height:30px;"> <br>
						<label style = "margin-top:0px; font-size: 15px;">Lot 3-4 Blk 4 Mountview Industrial Complex</label><br>
						<label style = "margin-top:0px; font-size: 15px;">Brgy. Bancal Carmona Cavite</label><br>
						<label style = "margin-top:0px; font-size: 15px;">Tel: +63(2)5844928 &nbsp; Fax: +63(2)5844952</label>
				</center>
				</td>
			
				<td style =" padding:0px; border:1px solid black; width:60%;"><center><h1>PURCHASE ORDER</h1></center></td>
