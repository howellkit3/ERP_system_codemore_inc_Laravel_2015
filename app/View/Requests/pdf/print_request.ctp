	...
	<div class="col-lg-12">
		<div class="main-box main-pdf"  >
			...
			<div style = "height: 48%">
				...
				<table  style="border:2px solid black;border-collapse:collapse; table-layout: fixed; width: 570;line-height: 0px; padding:0px; ">
				...
				<tr>
					<td align = "center" ></td>
					<td align = "center" style =" width:270px; word-wrap: break-word;" >Item Description</td>
				...
				<tr>
					<td align = "left" style=" width:183px; vertical-align: text-top; height:25px; ">Prepared by:</td>
				...
				<tr>
					<td align = "left" style=" width:185px; vertical-align: text-top; ">Purchasing</td>
					<td align = "left" style=" width:184px; vertical-align: text-top;">Dec. No:</td>
