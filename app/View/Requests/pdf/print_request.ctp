  ...
  height: 100%;background-repeat:no-repeat;">
	<div class="col-lg-12">
		<div class="main-box main-pdf"  >
			...
			<table  style="border:2px solid black;border-collapse:collapse; table-layout: fixed; width: 561;line-height: 0px; padding:0px; ">
			<!-- 	<thead>  
				<tr >
					<td align="center" style="width:500px;"></td>
					<td align="right" style="width:205px;"></td>
					<td align="center" style="width:200px align="right";" class ="pull-right"></td>
					<td></td>
			...
			<tr>
				<td align = "center" ></td>
				<td align = "center" style =" width:257px; word-wrap: break-word;" >Item Description</td>
			...
			<tr>
				...
				<td style="border:1px solid black;word-wrap: break-word;"><?php echo $requestRequestItem[$key]['RequestItem']['name']?></td>
        ...
        border-spacing: 1px ">
			...
			<tr>
				...
				<td align = "left" style=" width:180px; vertical-align: text-top;">Rev No:</td>
			</tr>
